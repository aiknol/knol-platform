    ...
    <div className="space-y-8">
      ...
      <AdminCard>
        <div className="flex items-center justify-between mb-4">
          ...
          <a href="/marketing" className="text-xs text-brand-400 hover:text-brand-300 transition-colors">
            View Analytics
          </a>
        </div>
        ...
        <div className="mt-3 flex gap-3">
          <a href="/campaigns" className="text-xs text-brand-400 hover:text-brand-300 transition-colors">
            Manage Campaigns →
          </a>
          <a href="/credentials?search=marketing" className="text-xs text-dark-400 hover:text-dark-200 transition-colors">
            Channel Credentials →
          </a>
        </div>
      </AdminCard>
      ...
      <AdminCard>
        <div className="flex items-center justify-between mb-4">
          ...
          <a href="/audit" className="text-xs text-brand-400 hover:text-brand-300 transition-colors">
            View all
          </a>
        </div>
