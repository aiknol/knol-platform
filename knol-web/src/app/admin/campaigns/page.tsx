      ...
      <AdminCard>
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-2">
            ...
            <a href="/admin/marketing" className="inline-flex items-center px-3 py-1.5 text-xs font-medium text-brand-400 bg-brand-500/10 border border-brand-500/30 rounded-lg hover:bg-brand-500/20 transition-colors">
              View Analytics
            </a>
          </div>
        </div>
